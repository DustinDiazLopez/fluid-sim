...
pub mod simulation {
    ...
    pub mod utils {
        ...
        pub(in crate::simulation) fn diffuse(
            b: i32,
            x: &mut Vec<f32>,
            x0: &Vec<f32>,
            diff: f32,
        ...
        pub(in crate::simulation) fn advect(
            b: i32,
            d: &mut Vec<f32>,
            d0: &Vec<f32>,
            veloc_x: &Vec<f32>,
        ...
        pub(in crate::simulation) fn project(
            veloc_x: &mut Vec<f32>,
            veloc_y: &mut Vec<f32>,
            veloc_z: &mut Vec<f32>,
            p: &mut Vec<f32>,
...
fn main() {
    let mut cube = simulation::FluidCube::new(10, 1.0, 1.0, 1.0);
